	...
	public void genLab() throws SlickException{
		...
		while (!liste.isEmpty()){
	        ...
	        if (pos.getI()!=0 && this.lab.get(pos.getI()-2).get(pos.getJ()) instanceof WallCase){
	        	this.lab.get(pos.getI()-2).add(pos.getJ(),new FreeCase(pos.getI(),pos.getJ(),50));
	        	this.lab.get(pos.getI()-2).remove(pos.getJ());
	        	this.lab.get(pos.getI()-1).add(pos.getJ(),new FreeCase(pos.getI(),pos.getJ(),50));
	        ...
	        if (pos.getJ()!=0 && this.lab.get(pos.getI()).get(pos.getJ()-2) instanceof WallCase){
	        	this.lab.get(pos.getI()).add(pos.getJ()-2,new FreeCase(pos.getI(),pos.getJ(),50));
	        	this.lab.get(pos.getI()).remove(pos.getJ()-2);
	        	this.lab.get(pos.getI()).add(pos.getJ()-1,new FreeCase(pos.getI(),pos.getJ(),50));
	        ...
	        for (int i=0;i<this.n;i++){
	        	for (int j=0;i<this.m;j++){
	        		int p = r.nextInt(100);
	        			if (p<=7) {
	        				this.lab.get(i).add(j,new FreeCase(i,j,50));
